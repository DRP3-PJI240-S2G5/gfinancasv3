"""
Django settings for gfinancas project.
...
MIDDLEWARE = [
    ...
    "gfinancas.base.middlewares.DjavueApiErrorHandlingMiddleware",
]
...
ROOT_URLCONF = "gfinancas.gfinancas.urls"
...
WSGI_APPLICATION = "gfinancas.gfinancas.wsgi.application"
...
#             'filename': os.getenv('DJANGO_LOG_FILE', './gfinancas.log'),
#             'formatter': 'simple'
#         },
#     },
#     'loggers': {
