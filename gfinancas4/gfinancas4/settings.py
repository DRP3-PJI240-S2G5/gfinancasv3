"""
Django settings for gfinancas4 project.
...
ALLOWED_HOSTS = config(
    "ALLOWED_HOSTS",
    default="gfinancas.app.br",
    cast=Csv(),
)

CSRF_TRUSTED_ORIGINS = config(
    "CSRF_TRUSTED_ORIGINS",
    default="https://gfinancas.app.br",
    cast=Csv(),
)
...
MIDDLEWARE = [
    ...
    "gfinancas4.base.middlewares.DjavueApiErrorHandlingMiddleware",
]
...
ROOT_URLCONF = "gfinancas4.gfinancas4.urls"
...
WSGI_APPLICATION = "gfinancas4.gfinancas4.wsgi.application"
...
#             'filename': os.getenv('DJANGO_LOG_FILE', './gfinancas4.log'),
#             'formatter': 'simple'
#         },
#     },
#     'loggers': {
